...
public class RecyclerElementosFragment extends Fragment {
    ...
    class ElementosAdapter extends RecyclerView.Adapter<ElementoViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ElementoViewHolder holder, int position) {
            ...
            // Cargar la imagen directamente desde drawable
            int resourceId = holder.itemView.getContext().getResources()
                    .getIdentifier(String.valueOf(elemento.imagen), "drawable", holder.itemView.getContext().getPackageName());
            holder.binding.imagen.setImageResource(resourceId);
